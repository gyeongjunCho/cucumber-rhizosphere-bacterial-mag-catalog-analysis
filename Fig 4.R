...
# =========================================================================
# Figure 4A. MAG catalogue subset relationships
# =========================================================================
...
# =========================================================================
# Figure 4B. ANI95 cluster-size composition
# =========================================================================
...
# =========================================================================
# Figure 4C. Sample occupancy of ANI95 clusters
# =========================================================================
...
# =========================================================================
# Figure 4D. ANI95 cluster sharing among samples
# =========================================================================
...
p4a_grob <- grid::grid.grabExpr(
  print(p4a)
)

p4a_gg <- ggpubr::as_ggplot(
  p4a_grob
)
...
ggsave(
  filename = "figure_and_table/Figure4.pdf",
  plot = fig4,
  width = 11.5,
  height = 10,
  units = "in",
